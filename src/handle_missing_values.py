...
if __name__ == "__main__":
    ...
    handle_missing_values = MissingValueHandler(DropMissingValues())
    handle_missing_values.execute_handle_missing_values(df)

    handle_missing_values.set_strategy(FillMissingValues())
    handle_missing_values.execute_handle_missing_values(df)